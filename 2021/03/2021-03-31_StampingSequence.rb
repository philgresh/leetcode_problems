...
# "abc??", "?abc?", "??abc" in the first turn.  (Note that the stamp must be fully contained in the boundaries 
# of the sequence in order to stamp.)
...
target = "ababc"
# Output: [0,2]
puts moves_to_stamp(stamp, target)
